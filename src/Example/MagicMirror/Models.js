...
// import FarmGLTF from 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/models/low-poly-farm/model.gltf'
// import RamenGLTF from 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/models/bowl-broth/model.gltf'
// import SodaGLTF from 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/models/soda-bottle/model.gltf'
// import HeliGLTF from 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/models/helicopter/model.gltf'
import FarmGLTF from './Farm.gltf'
import RamenGLTF from './Ramen.gltf'
import SodaGLTF from './Soda.gltf'
import HeliGLTF from './Heli.gltf'

export function Farm(props) {
  const { scene } = useGLTF(FarmGLTF)
  return <primitive onject={scene} {...props} />
}

export function Ramen(props) {
  const { scene } = useGLTF(RamenGLTF)
  return <primitive object={scene} {...props} />
}

export function Soda(props) {
  const { scene } = useGLTF(SodaGLTF)
  return <primitive object={scene} {...props} />
}
...
export function Heli(props) {
  ...
  // Load the gltf model
  const { nodes, materials } = useGLTF(HeliGLTF)
