...
import Effects from './InstancedVertexColorsEffects'
// import './InstancedVertexColors.css'
    ...
    for (let x=0; x<10; x++)
      for (let y=0; y<10; y++)
        for (let z=0; z<10; z++) {
          ...
          if (hovered !== prevRef.Current) { // Current, not current hmm...
...
export default function InstancedVertexColors() {
  return (
    <Canvas
      flat
